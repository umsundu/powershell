...
#PowerShell script to print which service rights the current user has against a service name.

#Usage: powershell Get-ServiceAcl -Name VulnServiceName | select -expand Access
